...
import { UserContext } from "../../context/userContext";
import Loader from "./Loader";
import { User, Mail, Lock, Power } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black text-white p-6">
      <div className="bg-neutral-900 rounded-2xl shadow-xl w-[90%] max-w-md p-8 flex flex-col items-center">
        {/* Logo or Circle */}
        <div className="w-14 h-14 rounded-full bg-gradient-to-r from-orange-400 to-pink-500 flex items-center justify-center mb-6">
        ...
        <form onSubmit={handleSignup} className="w-full">
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              value={fullName}
              onChange={(e) => setFullName(e.target.value)}
              className="w-full pl-10 pr-3 py-3 rounded-lg bg-neutral-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-orange-600 hover:bg-orange-700 transition text-white font-semibold py-3 rounded-lg mb-4"
          >
